...
public class MainActivity extends AppCompatActivity {
    ...
    //Button to Sign up and Log In using a toggle.
    public void toggleLoginMode(View view) {
        ...
        if (loginModeActive) {
            ...
            toggleLoginModeTextView.setText("Or, sign up");  //this is to switch the buttons basically
  ...
  public void signupLogin(View view) {
      ...
      if (loginModeActive) {
          ...
          ParseUser user = new ParseUser(); //adding the user here
